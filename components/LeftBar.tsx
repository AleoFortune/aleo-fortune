...
const LeftBar = (props: Props) => {
  ...
  return (
    <div
      className={cn(
        props.className,
        "border-r-[1px] border-gray-500 bg-muted px-2 py-2 hidden xl:flex flex-col items-center gap-2"
      )}
    >
      ...
      {account && (
        <Tabs defaultValue="depositHistory">
          ...
          <TabsContent value="depositHistory">
            ...
            <Separator orientation="horizontal" className="mb-2 text-white bg-red-500" />
                ...
                return (
                  <Card className="w-full rounded-sm px-2 py-2 " key={index}>
                    <CardTitle className="text-sm flex justify-between">
                      Status: <Badge variant={(e.status == "Pending" && "destructive") || "default"}>{e.status}</Badge>
                    </CardTitle>
                    <CardContent className="mt-2 p-0">
                      <div className="flex flex-col gap-2">
                        <p className="text-sm">
                          <span className="font-bold">Amount:</span>{" "}
                          <span className="text-red-300">{parseInt(e.inputs[1]!)}</span> Fortune Credits
                        </p>
                      </div>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent className="mt-2 p-0">
                      <div className="flex flex-col gap-2">
                        <p className="text-sm">
                          ...
                          <span className="text-red-300">{parseInt(e.inputs[0]!)}</span> Fortune Credits
                        </p>
                      </div>
                      <div className="flex flex-col gap-2">
                        <p className="text-sm">
                          <span className="font-bold">Bet: </span>{" "}
                          <span className="text-red-300">{parseInt(e.inputs[1]!)}</span>{" "}
                        </p>
                      </div>
                      <div className="flex flex-col gap-2">
                        <p className="text-sm">
                          <span className="font-bold">Game ID: </span> <span className="text-red-300">{e._id!}</span>{" "}
                        </p>
                      </div>
                    </CardContent>
                  </Card>
